...
output is the created order details
"""
@router.post("/payment/process", response_model=OrderResponseSchema)
async def process_payment(
    ...
    try:
        ...
        new_order = OrderService.process_payment(payment_data, db)
